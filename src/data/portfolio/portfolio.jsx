...
export const ua = {
	...
	haski: {
		...
		title: 'HASKI',
		pageTitle: 'Haski',
		description: `Haski є провідним постачальником послуг аутсорсингу. Він працює на ринку з 2008 року і вже міцно закріпився в ніші. Замовник вирішив масштабуватися, тому наявної функціональності стало недостатньо. Прийнявши завдання, ми зібрали команду для аналізу готового продукту замовника та планування подальших дій. Робочий процес виявився напрочуд цікавим і різноманітним, але складним і незвичайним у технічному виконанні. Під час розробки ми створили новий продукт, перенесли старі дані в нове середовище, інтегрували їх з готовою базою даних, забезпечили обмін інформацією між ними.`,
		responsibility: ['Mobile', 'Design'],
		fullDescription: `Haski є провідним постачальником послуг аутсорсингу. Він працює на ринку з 2008 року і вже міцно закріпився в ніші. Замовник вирішив масштабуватися, тому наявної функціональності стало недостатньо. Прийнявши завдання, ми зібрали команду для аналізу готового продукту замовника та планування подальших дій. Робочий процес виявився напрочуд цікавим і різноманітним, але складним і незвичайним у технічному виконанні. Під час розробки ми створили новий продукт, перенесли старі дані в нове середовище, інтегрували їх з готовою базою даних, забезпечили обмін інформацією між ними.`,
		pageContent: HaskiUa,
		links: {
			web: 'https://haski.ua',
			appStore: null,
	...
	onplay: {
		...
		longImage: OnPlayImg,
		title: 'OnPlay',
		pageTitle: 'З пранком по життю: нова соціальна мережа для розваг',
		description: `Наскільки інтерактивною може бути соціальна мережа? Після роботи над проектом PrankChat наша команда зрозуміла - залучення користувачів немає межі. Враховуючи наш божевільний ритм життя, постійні турботи та переживання, людям просто потрібна була програма, яка дозволяє розслабитися на всі 100%. І команда BuildApps створила його - ідеальний простір для спілкування, веселих відео та цікавого проведення часу.`,
		responsibility: ['Design', 'Mobile'],
		fullDescription: `Наскільки інтерактивною може бути соціальна мережа? Після роботи над проектом PrankChat наша команда зрозуміла - залучення користувачів немає межі. Враховуючи наш божевільний ритм життя, постійні турботи та переживання, людям просто потрібна була програма, яка дозволяє розслабитися на всі 100%. І команда BuildApps створила його - ідеальний простір для спілкування, веселих відео та цікавого проведення часу.`,
