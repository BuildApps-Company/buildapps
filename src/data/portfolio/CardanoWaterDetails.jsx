...
export const CardanoWaterRu = () => (
	<ProjectDetailsContainer>
		<H3>
      Cardano-Water: проблемы питьевой воды, которые заказчик захотел решить, отчисляя комиссию от торговли 10000 NFT на закупку чистой жидкости для нуждающихся
		</H3>
		<p>
    ...
    <p>
      Наш заказчик пришел к нам с платформы UpWork. Он надеялся, что мы справимся с проектом и реализуем его на все 100%. Что собственно и произошло. 
		</p>
    <ImageWrap>
      <img class="iphonediscount" src={mainImg} alt="picture1" />
    </ImageWrap>
    ...
    <p>
      Каждая сделка по продаже/покупке товара в коллекцию имеет небольшую комиссию. Этот процент зачисляется на специальный счет, с которого формируется благотворительный фонд. По накоплению определенной суммы, она автоматически перечисляется волонтерам в целевой стране, которые занимаются водоснабжением малообеспеченных слоев общества. Из этого исходят цели проекта:
		</p>
    <ul>
    ...
    <p>
      Поскольку ТЗ было грамотно сформировано, а опыт разработки веб-сайтов у нас имелся — мы приступили непосредственно к реализации проекта.
		</p>
		<ImageWrap>
			<img class="iphonediscount" src={detailsImg1} alt="picture3" />
    </ImageWrap>
		<H4>Мозговой штурм: идеи для реализации продукта и первые шаги к поставленной цели</H4>
		<p>
      Ознакомившись с идеей и проникшись ей, мы собрали команду для предварительного согласования дорожней карты проекта. В результате пришли к общему выводу, что основным инструментом привлечения ЦА к проблеме является лендинг и удобный быстрый сайт с разделами FAQ и полным описанием идеи. Это лучший рекламный инструмент, который повышает узнаваемость цифрового ресурса бренда на просторах сети интернет. На его реализацию мы и бросили свои основные силы.
		</p>
		<ImageWrap>
			<img class="iphonediscount" src={detailsImg2} alt="picture4" />
    </ImageWrap>
		...
		<p>
      Обсудив макет и согласовав его с заказчиком, мы приступили к работе над проектом. В процессе участвовали 2 эксперта веб-разработки. Мы начали работу, в процессе которой:
		</p>
    <ul>
			<li>
        Нарисовали вручную дизайн и скомпоновали интерфейс.
			</li>
			<li>
        Разметили страницу SPA и разбили ее на блоки.
			</li>
			<li>
        Адаптировали сайт под разные устройства с помощью React.js.
			</li>
		</ul>
    <p>
      В итоге получился адаптивный кроссплатформенный интерфейс с современным дизайном и плавной анимацией. Благодаря грамотным текстам и правильному наполнению страницы удалось вывести ее в топ поисковой выдачи Google. Поскольку проект сейчас находится в разработке, то судить о его эффективности рановато. В ближайшее время мы подключимся к разработке повторно для создания мобильных приложений и дополнительных ресурсов.
		</p>
		<H4>Чего мы добились, работая над перспективным проектом</H4>
    <p>
      Наш опыт позволил сразу сосредоточится на финальной версии, обойдя стороной проблемные места лендинга с блокчейном. С задачами мы справились за неполный месяц, создав уникальное и важное веб-решение для заказчика. В итоге получились:
		</p>
    <ul>
			<li>
        MVP с базовым функционалом и заложенным потенциалом на дальнейшее развитие проекта.
			</li>
			<li>
        Привлекательный дизайн с полной визуализацией процесса покупки и отчисления комиссии на оплату воды.
			</li>
			<li>
        Профессиональный лендинг с правильной разметкой, настройкой robots.txt.
			</li>
      <li>
        Качественная техническая поддержка и сотрудничество с дальнейшей перспективой.
			</li>
		</ul>
    <p>
      Клиент получил лучшее на рынке решение и функциональный продукт для развития NFT стартапа с филантропическим уклоном. Дизайн страницы привлекает внимание к насущной проблеме, а грамотный текст цепляет пользователей продуманными СТА и описаниями.
		</p>
    <H4>Улучшения для бизнеса клиента: апгрейд платформы за месяц</H4>
    <p>
    Поскольку проект еще находится в разработке, то пока трудно объективно оценивать эффективность. Но несмотря на это, идея уже привлекает инвесторов со всего мира, обеспечивая стартап необходимым для развития финансированием. От выполнения данной части IT-продукта, клиент получил:
		</p>
    <ul>
			<li>
        Удобный и быстрый инструмент для привлечения ЦА.
			</li>
			<li>
        Правильный лендинг с яркими и цепляющим СТА.
			</li>
			<li>
        Приток новых клиентов на целевой веб-ресурс.
			</li>
      <li>
        Финансирование стартапа с разных источников.
			</li>
		</ul>
    <p>
      Дорожная карта проекта далека от завершения, но те цели, что установила себе компания заслуживают уважения. Со временем Cardano Water добьется своего и обеспечит население чистой питьевой водой. А пока мы продолжаем активное сотрудничество, разрабатывая остальные элементы, реализуя идею заказчика в IT-мире. Мы гордимся, что BuildApps является весомой частью данного проекта.
		</p>
    <H3>
      Хотите оптимизировать свою главную страницу, запустить SPA или реализовать комплексный проект? У вас есть креативная идея, но нет ресурсов для разработки? Обращайтесь за консультацией к менеджеру BuildApps и получите качественный IT-продукт в короткие сроки!
    </H3>
	</ProjectDetailsContainer>
);
...
export const CardanoWaterUa = () => (
    ...
    <p>
      Оскільки ТЗ було грамотно сформовано, а досвід розробки веб-сайтів ми мали — було розпочато безпосередньо реалізацію проекту.
		</p>
		<ImageWrap>
			<img class="iphonediscount" src={detailsImg1} alt="picture3" />
    </ImageWrap>
		...
		<p>
      Ознайомившись з ідеєю та перейнявшись нею, ми зібрали команду для попереднього узгодження дорожньої карти проекту. В результаті дійшли загального висновку, що основним інструментом залучення ЦА до проблеми є лендинг, зручний швидкий сайт із розділами FAQ та повним описом ідеї. Це найкращий рекламний інструмент, який підвищує впізнання цифрового ресурсу бренду на просторах Інтернету. На її реалізацію ми й кинули свої основні сили.
		</p>
		<ImageWrap>
			<img class="iphonediscount" src={detailsImg2} alt="picture4" />
    </ImageWrap>
