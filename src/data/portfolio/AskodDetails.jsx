					...
					<BlockWrap>
						...
						<LowerDiv>
							...
							<p>
								...
								priority tasks. Among the requirements for the quality
								management system (QMS) there is a transparently delivered
								workflow, as well as information interaction between employees.
							</p>
						</LowerDiv>
					</BlockWrap>
					{isOpen && (
		...
		<>
			<MainImgWrap>
				...
				<GreyText>
					...
					поиск), а также взаимодействие между cотрудниками (передача
					документов, выдача задач, отправка уведомлений и т. Д.). Также такая
					система называется СЭД (Системы электронного документооборота).
				</GreyText>
			</MainImgWrap>
			<AskodWrap>
				<MainPageImg>
				...
				<ProjectDetailsContainer>
					<BlockWrap>
						<AdvantagesDiv>
							<H3>Преимущества</H3>
							<p>
								Прозрачность бизнес-процессов. Благодаря системе можно
								отслеживать все шаги в организации. Бизнес-процессы становятся
								полностью прозрачными для управления и их легче контролировать.
							</p>
						</AdvantagesDiv>
						<ImgWrap>
							<img src={detailsImg} alt="detailsImg" />
					...
					<div>
						...
						<p>
							По статистике, 20% полученных заданий не выполняются
							ответственными за них сотрудниками. Имея полный контроль над всеми
							этапами работы, ECM-система напрямую влияет на исполнительскую
					...
					<BlockWrap>
						...
						<LowerDiv>
							...
							<p>
								Система сокращает время, которое сотрудники тратят практически
								на все рутинные операции с документами: создание, поиск,
								утверждение и так далее. Ускоряется документооборот. В
								результате все процессы в организации проходят быстрее.
							</p>
						</LowerDiv>
					</BlockWrap>
					<BlockWrap>
						<AdvantagesDiv>
							...
							<p>
								Нарушение целостности данных может нанести организации миллионы
								убытков. В отличие от традиционного «бумажного»
								документооборота, ECM-система предоставляет доступ к документам
								строго в соответствии с назначенными правами пользователя. Все
					...
					<BlockWrap>
						...
						<LowerDiv>
							...
							<p>
								Построение менеджмента качества стало одной из приоритетных
								задач. Среди требований к системе менеджмента качества (QMS) -
								прозрачно поставленный рабочий процесс, а также информационное
						...
						<>
							<BlockWrap>
								<AdvantagesDiv>
									...
									<p>
										Благодаря системе уведомлений, построенной на базе
										ECM-системы, вы можете быстро довести новые правила работы
										до всех сотрудников. Время обучения новых сотрудников
										сокращается за счет быстрого поиска необходимой информации
										(положения, инструкции и т.д.). Маршруты и шаблоны
										документов легко меняются, после чего сотрудники
							...
							<BlockWrap>
								...
								<LowerDiv>
									...
									<p>
										Система ECM напрямую влияет на конкурентные преимущества
										компании перед другими игроками рынка. Скорость и качество
										обслуживания клиентов повышаются за счет быстрого движения
										информационных потоков и точного контроля всех процессов.
										Даже самое крупное предприятие становится более мобильным и
										менее зависимым от некоторых «незаменимых» сотрудников.
									</p>
								</LowerDiv>
							</BlockWrap>
						</>
		...
		<>
			<MainImgWrap>
				...
				<GreyText>
					...
					модифікація, пошук), а також взаємодію між співробітниками (передача
					документів, видача завдань, відправка повідомлень тощо). Також така
					система називається EDMS (Electronic Document Management Systems).
				</GreyText>
			</MainImgWrap>
			<AskodWrap>
				<MainPageImg>
				...
				<ProjectDetailsContainer>
					<BlockWrap>
						<AdvantagesDiv>
							<H3>Переваги</H3>
							<p>
								Прозорість бізнес-процесів. Завдяки системі можна контролювати
								всі кроки в організації. Бізнес-процеси стають абсолютно
								прозорими для керівництва і їх легше контролювати.
							</p>
						</AdvantagesDiv>
						<ImgWrap>
							<img src={detailsImg} alt="detailsImg" />
					...
					<div>
						...
						<p>
							...
							відповідальними за них працівниками. При повному контролі за всіма
							етапами роботи, система ECM безпосередньо впливає на службову
							дисципліну співробітників.
						</p>
					</div>
					<BlockWrap>
						<ImgWrap>
						...
						<LowerDiv>
							<H3>
								Нижчі витрати на оплату праці для керівників і співробітників
							</H3>
							<p>
								Система скорочує час, який співробітники витрачають практично на
								всі рутинні операції з документами: створення, пошук,
								затвердження тощо. Прискорюється документообіг. І в результаті
								всі процеси в організації проходять швидше.
							</p>
						</LowerDiv>
					</BlockWrap>
					<BlockWrap>
						<AdvantagesDiv>
							...
							<p>
								...
								відповідно до призначених прав користувача. Усі дії з документом
								(читання, зміна, підписання) записуються.
							</p>
						</AdvantagesDiv>
						<ImgWrap>
							<img src={login} alt="login" />
					...
					<BlockWrap>
						...
						<LowerDiv>
							...
							<p>
								...
								завдань. Серед вимог до системи менеджменту якості (QMS) —
								прозоро поставлений робочий процес, а також інформаційна
						...
						<>
							<BlockWrap>
								<AdvantagesDiv>
									...
									<p>
										...
										можна швидко довести нові правила роботи до всіх
										співробітників. Час навчання нових працівників скорочується
										за рахунок швидкого пошуку необхідної інформації (положення,
										інструкції тощо). Маршрути та шаблони документів легко
										змінюються, після чого співробітники автоматично починають
										працювати по-новому.
									</p>
								</AdvantagesDiv>
								<ImgWrap>
							...
							<BlockWrap>
								...
								<LowerDiv>
									...
									<p>
										Система ECM безпосередньо впливає на конкурентні переваги
										компанії над іншими гравцями ринку. Швидкість і якість
										обслуговування клієнтів підвищується за рахунок швидкого
										руху інформаційних потоків і точного контролю всіх процесів.
										Навіть найбільше підприємство стає мобільнішим і менш
										залежним від деяких «незамінних» співробітників.
									</p>
								</LowerDiv>
							</BlockWrap>
						</>
