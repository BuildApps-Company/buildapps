			...
			<PortfolioDetails id={'ppf'}>
				<ProjectDetailsContainer>
					...
					<ul>
						...
						<li>
							- Software modules expand the platform's automation capabilities
							and speed up tasks, allowing employees to do more useful things
							than manual processing of a large number of paper documents.
						</li>
					</ul>
					<H4>
					...
					<ul>
						<li>
							- CRM provides and generates an easy-to-read statement on the
							credit history of a given client / entity with the help of
							specialized services and modules
						</li>
						<li>
					...
					<ul>
						...
						<li>
							- Mechanism for creating reports on various parts of the system.
							For example: bank statement, uploading reports on applications,
							etc.
						</li>
						<li>
